...
namespace Perceiveit.Data.UnitTests.MySQL
{
    [TestClass]
    public class MySQLComplete
    {
        ...
        public void InitDbs()
        {
            ...
            DBDatabase mysql = DBDatabase.Create("MySQL"
                                                    , MySQL.Schools.DbConnection
                                                    , MySQL.Schools.DbProvider);
        ...
        #region public void MySQL_01_CreateV1Tables()

        /// <summary>
        /// Create all the Version 1 data tables using the SQLCLient Schools schema
        /// </summary>
        [TestMethod()]
        public void MySQL_01_CreateV1Tables()
        {
        ...
        #region public void MySQL_02_InsertDepartmentData()
        ...
        /// </summary>
        [TestMethod()]
        public void MySQL_02_InsertDepartmentData()
        {
            DBDatabase db = this.Database;
        ...
        #region public void MySQL_03_InsertCourseData()

        [TestMethod()]
        public void MySQL_03_InsertCourseData()
        {
        ...
        #region public void MySQL_04_InsertOnSiteCourseData()
        ...
        /// </summary>
        [TestMethod()]
        public void MySQL_04_InsertOnSiteCourseData()
        {
            DBDatabase db = this.Database;
        ...
        #region public void MySQL_05_InsertOnlineCourseData()

        /// <summary>
        /// Non transactional inserts into the database for all the online courses
        /// </summary>
        [TestMethod()]
        public void MySQL_05_InsertOnlineCourseData()
        {
            DBDatabase db = this.Database;
        ...
        #region public void MySQL_06_InsertPeopleData()
        ...
        /// </summary>
        [TestMethod()]
        public void MySQL_06_InsertPeopleData()
        {
            DBDatabase db = this.Database;
        ...
        #region public void MySQL_07_InsertInstructors()
        ...
        /// </summary>
        [TestMethod()]
        public void MySQL_07_InsertInstructors()
        {
            DBDatabase db = this.Database;
        ...
        #region public void MySQL_08_CreateIndexes()
        ...
        /// </summary>
        [TestMethod()]
        public void MySQL_08_CreateIndexes()
        {
            DBDatabase db = this.Database;

            //Create unique index on Department name if it doesn't exist
            DBQuery create = DBQuery.Create.Index(DeptNameIndex).Unique().On(Schools.Schema, Schools.Departments.Table)
            ...
            create = DBQuery.Create.Index(CourseTitleIndex).Unique()
        ...
        #region public void MySQL_09_UpdateCourseAdministrators()
        ...
        /// </summary>
        [TestMethod()]
        public void MySQL_09_UpdateCourseAdministrators()
        {
            DBDatabase db = this.Database;
        ...
        #region public void MySQL_10_CreateCourseViews()
        ...
        /// </summary>
        [TestMethod()]
        public void MySQL_10_CreateCourseViews()
        {
            DBDatabase db = this.Database;
        ...
        #region public void MySQL_11_CreateOnsiteCourseSProc()
        ...
        /// </summary>
        [TestMethod()]
        public void MySQL_11_CreateOnsiteCourseSProc()
        {
            DBDatabase db = this.Database;
            ...
            ocdays.Value = 5;
            octime.Value = TimeSpan.Parse("11:00:00"); //Use TimeSpan for time columns
        ...
        #region public void MySQL_12_CreateOnlineCourseSproc()
        ...
        /// </summary>
        [TestMethod()]
        public void MySQL_12_CreateOnlineCourseSproc()
        {
             DBDatabase db = this.Database;
        ...
        #region public void MySQL_13_SelectDepartmentCourses()

        /// <summary>
        /// Selects all the courses in a department including the 
        /// </summary>
        [TestMethod()]
        public void MySQL_13_SelectDepartmentCourses()
        {
        ...
        #region public void MySQL_14_DeleteAnOnsiteCourse()
        ...
        /// </summary>
        [TestMethod()]
        public void MySQL_14_DeleteAnOnsiteCourse()
        {
        ...
        #region public void MySQL_15_ValidateTableSchema()

        [TestMethod()]
        public void MySQL_15_ValidateTableSchema()
        {
            DBDatabase db = this.Database;
        ...
        private void ValidateTableColumns(Schema.DBSchemaTable table, params DBColumn[] columns)
        {
            foreach (DBColumn col in columns)
            {
                ...
                if (schemaCol.NativeType.ToUpper() == "TEXT" || schemaCol.NativeType.ToUpper() == "MEDIUMTEXT" || schemaCol.NativeType.ToUpper() == "LONGTEXT")
                    Assert.IsTrue(col.Type == DbType.String || col.Type == DbType.AnsiString);
                else
                {
                    Assert.AreEqual(schemaCol.DbType, col.Type, "The column '{3}.{0}' actual type is '{1}', but should have been generated with '{2}'", col.Name, col.Type, schemaCol.DbType, table.Name);
                    
                    if (col.Length > 0 && (col.Type == DbType.AnsiString || col.Type == DbType.AnsiStringFixedLength || col.Type == DbType.String || col.Type == DbType.StringFixedLength))
        ...
        #region public void MySQL_16_ValidateViewSchema()

        [TestMethod()]
        public void MySQL_16_ValidateViewSchema()
        {
            DBDatabase db = this.Database;
            Schema.DBSchemaProvider provider = db.GetSchemaProvider();
        ...
        #region public void MySQL_17_ValidateIndexSchema()

        [TestMethod()]
        public void MySQL_17_ValidateIndexSchema()
        {
            DBDatabase db = this.Database;
            Schema.DBSchemaProvider provider = db.GetSchemaProvider();
        ...
        #region public void MySQL_18_ValidateSprocSchema()

        [TestMethod()]
        public void MySQL_18_ValidateSprocSchema()
        {
            DBDatabase db = this.Database;
            Schema.DBSchemaProvider provider = db.GetSchemaProvider();
