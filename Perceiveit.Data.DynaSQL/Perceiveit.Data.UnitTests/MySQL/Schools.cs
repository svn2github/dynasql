...
{
    /// <summary>
    /// The full Schema of the School for the MySQL  database
    /// </summary>
    public class Schools
    {
        ...
        /// </summary>
        public const string DbConnection = "server=172.16.56.1;User Id=testaccount;Password=test;Persist Security Info=True;database=northwind;Allow User Variables=true";
        ...
        /// </summary>
        public const string Schema = "Northwind";

        public class Departments
        {
            public const string Table = "DSQL_DEPARTMENT";
            public static readonly DBColumn Id = DBColumn.Column("DepartmentID", System.Data.DbType.Int32, DBColumnFlags.PrimaryKey | DBColumnFlags.AutoAssign);
            public static readonly DBColumn Name = DBColumn.Column("Name", System.Data.DbType.String, 100);
            public static readonly DBColumn DateCreated = DBColumn.Column("Created", System.Data.DbType.DateTime2);
            public static readonly DBColumn LastModified = DBColumn.Column("LastModified", System.Data.DbType.DateTime2);
            public static readonly DBColumn Budget = DBColumn.Column("Budget", System.Data.DbType.Currency, DBColumnFlags.Nullable);
        ...
        public class Courses
        {
            ...
            public static readonly DBColumn Department = DBColumn.Column("DepartmentID", System.Data.DbType.Int32);
