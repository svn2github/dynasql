...
namespace Scryber.Drawing
{
    ...
    public struct PDFThickness : IComparable<PDFThickness>, IEquatable<PDFThickness>, ICloneable
    {
        ...
        /// <summary>
        /// Parses a string value in the format [T,L,B,R] into a PDFThickness instance
        /// </summary>
        ...
        public static PDFThickness Parse(string value)
        {
            if (String.IsNullOrEmpty(value))
                throw new ArgumentNullException("value", String.Format(Errors.CouldNotParseValue_3, value, "PDFThickness", "[T,L,B,R]"));

            if (value.StartsWith(ThicknessStartChar.ToString()) == false || value.EndsWith(ThicknessEndChar.ToString()) == false)
                throw new ArgumentNullException("value", String.Format(Errors.CouldNotParseValue_3, value, "PDFThickness", "[T,L,B,R]"));
            ...
            if (thick.Length != 4)
                throw new ArgumentException("value", String.Format(Errors.CouldNotParseValue_3, value, "PDFThickness", "[T,L,B,R]"));
