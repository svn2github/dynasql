...
namespace Scryber.Drawing.Imaging
{
    internal class PDFJpegImageData : PDFImageData
    {
        ...
        {
            this.BitsPerColor = ImageFormatParser.GetImageBitDepth(jpeg.PixelFormat) / 3;
            ...
            this.HorizontalResolution = jpeg.HorizontalResolution;
            this.VerticalResolution = jpeg.VerticalResolution;
