...
namespace Scryber.Components
{
    ...
    public class PDFLayerGroup : PDFVisualComponent, IPDFViewPortComponent
    {
        ...
        public PDFLayerGroup()
            : this(PDFObjectTypes.LayerGroup)
        {
        }

        public PDFLayerGroup(PDFObjectType type)
            : base(type)
        {
        }
        ...
        {
            return new Support.CanvasLayoutEngine(this, parent, context);
        }
