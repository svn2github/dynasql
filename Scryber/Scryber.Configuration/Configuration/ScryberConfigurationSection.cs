...
namespace Scryber.Configuration
{
    public class ScryberConfigurationSection : ConfigurationSection
    {
        ...
        public TracingSection Tracing
        {
            get 
            {
                TracingSection section = this[TraceKey] as TracingSection;
                return section;
            }
            set
            {
        ...
        public FontMappingSection FontMappings
        {
            get { return this[FontMappingSectionKey] as FontMappingSection; }
