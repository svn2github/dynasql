...
{
    public class FontMappingSection : System.Configuration.ConfigurationElement
    {
        ...
        /// </summary>
        [ConfigurationProperty(FontSubstitutionKey, IsRequired=false)]
        ...
        /// if a matching font could not be found on the system
        /// </summary>
        [ConfigurationProperty(UseSystemFontsKey, IsRequired = false)]
