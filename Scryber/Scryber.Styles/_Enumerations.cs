...
namespace Scryber
{
    ...
    {
        NewPage, //overflow will be pushed onto a new page
        Truncate, //overflow will not be rendered
        None //no action - rendered beyond any page boundaries
    }
    ...
    public enum PositionMode
    {
        ...
        Relative,
        /// <summary>
        /// No Expicit postion - next slot down the page.
        /// </summary>
        Flow
    }
